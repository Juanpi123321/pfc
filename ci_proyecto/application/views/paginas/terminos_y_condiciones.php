	<!-- Principal terminos y condiciones -->
					        ...
					        <div class="modal-content">
				            	...
				            	<div class="modal-body">
				            		<div id="leermas" class="text-justify" style="margin: 15px;">
										<p>En función de los expresado, se fija en el presente los términos y condiciones a los efectos del uso por parte del Usuario Cliente del sitio <a href="<?php echo base_url(); ?>">www.pcgamer.com.ar</a>.</p>
										...
										<p>10. Proceso de compra: Sin perjuicio de encontrarse detallado el proceso de compra en el sitio <a href="<?php echo base_url(); ?>">http://www.pcgamer.com.ar</a> el mismo se detalla a continuación:</p>
										...
										<p>19. Legislación aplicable: el presente es regido por las leyes de la República Argentina.</p><br>
										<button type="button" class="btn btn-default center-block" data-dismiss="modal">Cerrar ventana</button>
					                	<br>
								    </div>			                
					            </div>            
					        </div>
